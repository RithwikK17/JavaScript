...
document.writeln(`<h3> cbrt(27) = ${Math.cbrt(27)}</h3>`)
...
document.writeln(`<h3>round(2.2)=${Math.round(2.2)}</h3>`) /* >= 0.49 = lowest int */
document.writeln(`<h3>round(2.6)=${Math.round(2.6)}</h3>`) /* < 0.5 = highest int */
...
document.writeln(`<h3>acosh(x) = ${Math.acos(2)}</h3>`)

document.writeln(`<hr/>`)

document.writeln(`<h3> trunc(x) = ${Math.trunc(12.33)}</h3>`)
document.writeln(`<h3> trunc(x) = ${Math.trunc(0.33)}</h3>`)
document.writeln(`<h3> fround(x) = ${Math.fround(5.389699899).toFixed(3)}</h3>`)
